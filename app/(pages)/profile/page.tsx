    ...
    const fetchBookingBlocks = async () => {
      try {
        ...
        interface BookingData {
          ...
          bufferStartDate?: string | Date | null;
          status?: string;
        }
        ...
        activeBookings.forEach((booking: BookingData) => {
          ...
          const executionEnd = parseDate(booking.executionEndDate)
          const bufferStart = parseDate(booking.bufferStartDate)
          const scheduledEnd = parseDate(booking.scheduledEndDate)
          ...
          <Card className="md:col-span-2">
            ...
            <TabsContent value="personal-availability" className="space-y-6">
              ...
              <AvailabilityCalendar
                ...
                companyBlockedDates={[...companyBlockedDates, ...bookingBlockedDates]}
